...
\]
dass die rechte Seite Lipschitz-stetig in der x-Variable ist, wodurch eindeutige Lösbarkeit folgt. Die Lösung $x$ kann
mit Hilfe der \textit{Matrixexponentialfunktion} \cite{Matrixexponential} angegeben werden:
\begin{align}
