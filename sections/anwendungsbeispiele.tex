...
den Vergleichswert, der durch eine weitere Berechnung der $scipy.integrate.RK45$-Funktion entsteht, setzen wir
...
\begin{figure}
       \centering
       \includegraphics[scale=0.9]{Rebound_plots/reboundpendulumavr_loss}
...
\begin{figure}
       \centering
       \includegraphics[scale=0.9]{harmonicoscillator_plots/harmonicoscillatorML_error__neurons_var_avrloss}
...
\begin{figure}
       \centering
       \includegraphics[scale=0.9]{harmonicoscillator_plots/harmonicoscillatorError_in_time_neurons_var}
...
\begin{figure}
       \centering
       \includegraphics[scale=0.9]{harmonicoscillator_plots/harmonicoscillatorML_error__layers_var_avrloss}
       \caption{Kostenfunktion der verschiedenen neuronalen Netze.}
...
\begin{figure}
       \centering
       \includegraphics[scale=0.9]{harmonicoscillator_plots/harmonicoscillatorError_in_time_layers_var}
